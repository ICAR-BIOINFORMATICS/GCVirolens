...
class GCVirolensApp:
    def __init__(self, root):
        ...
        self.fasta_button = tk.Button(root, text="Upload genomic file i.e  .fasta format",relief="sunken", command=self.upload_fasta, borderwidth=3,bg= "grey")
        self.fasta_button.grid(column=0, row=2, columnspan=2, pady=10, padx=20)

        # Button to upload a GFF file
        self.gff_button = tk.Button(root, text="Upload annotation file i.e  .gff format",relief="sunken", command=self.upload_gff, borderwidth=3,bg= "grey")
        ...
        self.save_button = tk.Button(root, text="Save Result",relief="raised", command=self.save_result, borderwidth=3,bg="green")
